export const en: Record<string, string> = {
  ...
  'tor.required_notice': 'Start bundled Tor first. An Android VPN can carry Tor outbound traffic; do not configure 127.0.0.1:10808 here.',
  ...
  'tor.webtunnel_failed': 'WebTunnel could not be fetched or started. Check the VPN and try again.',
