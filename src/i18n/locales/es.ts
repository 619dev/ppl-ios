export const es: Record<string, string> = {
  ...
  'bark.title': 'Notificaciones Bark', 'bark.description': 'Cuando estás sin conexión, el servidor de PaperPhoneLite envía los avisos de mensajes nuevos a tu URL de Bark sin el contenido del mensaje.', 'bark.endpoint': 'URL de Bark', 'bark.endpoint_hint': 'Pega la URL completa, incluida la clave del dispositivo. La clave se envía únicamente al servidor de PaperPhoneLite actual.', 'bark.apns_notice': 'Incluso con alojamiento propio, la app Bark para iOS usa finalmente Apple APNs.', 'bark.configured': 'Bark está activado', 'bark.not_configured': 'Bark no está configurado', 'bark.saved': 'Configuración de Bark guardada', 'bark.test': 'Enviar prueba', 'bark.test_sent': 'Notificación de prueba enviada', 'bark.disable': 'Desactivar Bark', 'bark.disabled': 'Bark desactivado', 'bark.invalid_url': 'Introduce una URL HTTP o HTTPS válida', 'bark.missing_key': 'La URL de Bark debe incluir una clave de dispositivo', 'bark.server_unsupported': 'Este servidor aún no admite Bark.',
  ...
  'tor.starting_webtunnel': 'Creando circuito Tor mediante WebTunnel…',
  'tor.webtunnel_failed': 'No se pudo obtener o iniciar WebTunnel. Comprueba la VPN e inténtalo de nuevo.',
