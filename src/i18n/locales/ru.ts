export const ru: Record<string, string> = {
  ...
  'bark.title': 'Уведомления Bark', 'bark.description': 'В автономном режиме сервер PaperPhoneLite отправляет уведомления о новых сообщениях на URL Bark без текста сообщения.', 'bark.endpoint': 'URL Bark', 'bark.endpoint_hint': 'Вставьте полный URL с ключом устройства. Ключ отправляется только на текущий сервер PaperPhoneLite.', 'bark.apns_notice': 'Даже при самостоятельном размещении приложение Bark для iOS в итоге использует Apple APNs.', 'bark.configured': 'Bark включён', 'bark.not_configured': 'Bark не настроен', 'bark.saved': 'Настройки Bark сохранены', 'bark.test': 'Отправить тест', 'bark.test_sent': 'Тестовое уведомление отправлено', 'bark.disable': 'Отключить Bark', 'bark.disabled': 'Bark отключён', 'bark.invalid_url': 'Введите корректный HTTP- или HTTPS-URL', 'bark.missing_key': 'URL Bark должен содержать ключ устройства', 'bark.server_unsupported': 'Этот сервер пока не поддерживает Bark.',
  ...
  'tor.start': 'Запустить клиент Tor',
  'tor.starting': 'Создание цепочки Tor…',
  'tor.ready': 'Tor готов',
  'tor.ready_detail': 'Цепочка Tor создана, и трафик приложения направлен через встроенный Tor. Можно войти или зарегистрироваться.',
  'tor.required_notice': 'Сначала запустите встроенный Tor. Приложение автоматически направляет подключения .onion через Tor; локальный адрес прокси здесь не требуется.',
  'tor.required_before_auth': 'Tor ещё не готов. Запустите Tor и дождитесь рабочего состояния.',
  'tor.start_failed': 'Не удалось запустить Tor. Проверьте сеть или VPN и повторите попытку.',
  'tor.fetching_webtunnel': 'Прямое подключение Tor заблокировано. Получение актуального WebTunnel от Tor Project…',
  'tor.starting_webtunnel': 'Создание цепочки Tor через WebTunnel…',
  'tor.webtunnel_failed': 'Не удалось получить или запустить WebTunnel. Проверьте VPN и повторите попытку.',
