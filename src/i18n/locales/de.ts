export const de: Record<string, string> = {
  ...
  'bark.title': 'Bark-Benachrichtigungen', 'bark.description': 'Offline sendet der PaperPhoneLite-Server Hinweise auf neue Nachrichten ohne Nachrichteninhalt an Ihre Bark-URL.', 'bark.endpoint': 'Bark-URL', 'bark.endpoint_hint': 'Fügen Sie die vollständige URL einschließlich Geräteschlüssel ein. Der Schlüssel wird nur an den aktuellen PaperPhoneLite-Server gesendet.', 'bark.apns_notice': 'Auch bei Self-Hosting nutzt die Bark-iOS-App letztlich Apple APNs.', 'bark.configured': 'Bark ist aktiviert', 'bark.not_configured': 'Bark ist nicht eingerichtet', 'bark.saved': 'Bark-Einstellungen gespeichert', 'bark.test': 'Test senden', 'bark.test_sent': 'Testbenachrichtigung gesendet', 'bark.disable': 'Bark deaktivieren', 'bark.disabled': 'Bark deaktiviert', 'bark.invalid_url': 'Geben Sie eine gültige HTTP- oder HTTPS-URL ein', 'bark.missing_key': 'Die Bark-URL muss einen Geräteschlüssel enthalten', 'bark.server_unsupported': 'Dieser Server unterstützt Bark noch nicht.',
