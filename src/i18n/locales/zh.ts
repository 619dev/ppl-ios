export const zh: Record<string, string> = {
  ...
  'bark.description': '离线时，PaperPhoneLite 服务器会把新消息提醒发送到你配置的 Bark 地址。通知只包含发件人和通用提示，不包含消息正文。',
  'bark.endpoint': 'Bark 推送地址',
  'bark.endpoint_hint': '请粘贴 Bark App 提供的完整地址（包含设备密钥）。密钥只提交到当前 PaperPhoneLite 服务器，不保存在本机网页存储中。',
