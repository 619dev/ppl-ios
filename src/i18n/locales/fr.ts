export const fr: Record<string, string> = {
  ...
  'bark.title': 'Notifications Bark', 'bark.description': 'Hors ligne, le serveur PaperPhoneLite envoie les alertes de nouveaux messages à votre URL Bark sans le contenu du message.', 'bark.endpoint': 'URL Bark', 'bark.endpoint_hint': 'Collez l\'URL complète incluant la clé de l\'appareil. La clé est envoyée uniquement au serveur PaperPhoneLite actuel.', 'bark.apns_notice': 'Même auto-hébergée, l\'app Bark iOS utilise finalement Apple APNs.', 'bark.configured': 'Bark est activé', 'bark.not_configured': 'Bark n\'est pas configuré', 'bark.saved': 'Configuration Bark enregistrée', 'bark.test': 'Envoyer un test', 'bark.test_sent': 'Notification de test envoyée', 'bark.disable': 'Désactiver Bark', 'bark.disabled': 'Bark désactivé', 'bark.invalid_url': 'Saisissez une URL HTTP ou HTTPS valide', 'bark.missing_key': 'L\'URL Bark doit inclure une clé d\'appareil', 'bark.server_unsupported': 'Ce serveur ne prend pas encore en charge Bark.',
  ...
  'tor.start': 'Démarrer le client Tor',
  'tor.starting': 'Création du circuit Tor…',
  'tor.ready': 'Tor est prêt',
  'tor.ready_detail': "Un circuit Tor est établi et le trafic de l’application passe par Tor intégré. Vous pouvez vous connecter ou vous inscrire.",
  'tor.required_notice': "Démarrez d’abord Tor intégré. L’app achemine automatiquement les connexions .onion via Tor ; aucune adresse de proxy local n’est nécessaire ici.",
  'tor.required_before_auth': "Tor n’est pas prêt. Démarrez Tor et attendez son état opérationnel.",
  'tor.start_failed': 'Échec du démarrage de Tor. Vérifiez le réseau ou le VPN puis réessayez.',
  'tor.fetching_webtunnel': 'La connexion Tor directe est bloquée. Récupération du dernier WebTunnel auprès de Tor Project…',
  'tor.starting_webtunnel': 'Création du circuit Tor via WebTunnel…',
  'tor.webtunnel_failed': "Impossible de récupérer ou démarrer WebTunnel. Vérifiez le VPN et réessayez.",
